      ...
      >
        ...
        >
          <button
            ...
            onClick={onClose}
            disabled={submitting}
            className="flex-1 h-11 rounded-lg text-body-md font-semibold transition-colors"
            style={{
              border: "1px solid var(--color-outline-variant)",
          ...
          <button
            ...
            id="labour-drawer-submit"
            className="flex-1 h-11 rounded-lg text-body-md font-semibold transition-opacity"
            style={{
